...
foldername: str = os.path.join(
    ...
    f"linear_to_power_both_rel_perms_min_param_{MIN_PARAM}",
...
params = {
    ...
    "linear_flow": False,
    "homotopy_continuation_param_min": MIN_PARAM,
}
...
model = BuckleyLeverettSetup_HomotopyContinuation_BothRelPerm_LineartoPower(params)
...
for decay in decays:
    ...
    foldername = os.path.join(
        ...
        "homotopy_continuation",
        f"linear_to_power_both_rel_perms_min_param_{MIN_PARAM}",
        f"homotopy_continuation_decay_{decay:.2f}",
    )
    ...
    analysis = ConvergenceAnalysisExtended(
        BuckleyLeverettSetup_HomotopyContinuation_BothRelPerm_LineartoPower,
        params,
        levels=7,
    ...
    save_convergence_results(
        ...
        results,
        "time",
        courant_number=DEFAULT_MAX_TIME_STEP,
        max_iterations=MAX_NEWTON_ITERATIONS,
