...
if __name__ == "__main__":
    ...
    configs_varying_rp_init_s_02 = configs[::9] + configs[1::9] + configs[2::9]
    configs_varying_rp_init_s_03 = configs[3::9] + configs[4::9] + configs[5::9]
    configs_varying_init_s = (
        configs[::9] + configs[6::9] + configs[7::9] + configs[8::9] + configs[3::9]
    )
    # data = {}
    ...
    #     data,
    #     "Rel. perm. model",
    #     title=r"NL iterations by solver and rel. perm. model. $s_{init} = 0.2$",
    # )
    # data = {}
    ...
    #     data,
    #     "Rel. perm. model",
    #     title=r"NL iterations by solver and rel. perm. model. $s_{init} = 0.3$",
    # )
    data = {}
    ...
    #     data,
    #     r"$s_{init}$",
    #     title=r"NL iterations by solver and $s_{init}$. Brooks-Corey rel. perm.",
    # )
