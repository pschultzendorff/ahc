"""Analyze the Newton iterations of one time step of homotopy continuation from a linear
relative permeability model to a Corey relative permeability model."""
...
# Run one time step
###################
setup = BuckleyLeverettSetup_HomotopyContinuation_RelPerm_LineartoPower(params)
