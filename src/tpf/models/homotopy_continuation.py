...
from tpf.models.flow_and_transport import SolutionStrategyTPF, SolverStatisticsTPF
...
from tpf.numerics.quadrature import BaseScheme, Integral
...
class RelativePermeabilityHC(HCProtocol, RelativePermeability):
    """
...
class EstimatesHCMixin(EstimatesProtocol, ReconstructionProtocol, TPFProtocol):
...
class SolutionStrategyHCMixin(HCProtocol, EstimatesProtocol, TPFProtocol):
