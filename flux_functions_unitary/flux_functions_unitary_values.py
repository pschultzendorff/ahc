...
permeability: float = 1.0  # [m^2]
mu_w: float = 1.0  # Viscosity of wetting phase [mP??]
mu_n: float = 1.0  # Viscosity of non-wetting phase [mP??]
rho_w: float = 1.0  # Density of wetting phase [kg m^-3]
rho_n: float = 1.0  # Density of non-wetting phase [kg m^-3]
G: float = 1.0  # Gravity [m^2s^-2]
L: float = 1.0  # Characteristic length scale [m]
P_c_bar: float = 1.0  # Characteristic capillary pressure [Pa]
